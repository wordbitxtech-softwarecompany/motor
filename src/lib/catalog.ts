...
const FAMILY_RULES: string[] = [
  ...
  'JE 70L', 'JE 70 Pro', 'JE 125', 'Jolta Scooty', 'Jolta Cargo',
  'Bolt', 'Retro', 'Vlektra 125E', 'Vlektra Swift',
  'Yadea C1S', 'Yadea G5', 'Yadea T9', 'Yadea KS3', 'Yadea VFD',
  'Evee C1', 'Evee Cargo', 'Evee Zenith',
  ...
  'Vespa Primavera', 'Vespa Sprint', 'Vespa GTS', 'Vespa Elettrica',
