...
export const BRANDS: Brand[] = [
  ...
  },
  {
    ...
    tagline: 'Adventure SUVs on sale in Pakistan — Dashing, X70 Plus, T1 and T2. T3 is listed as upcoming.',
    models: [
      { name: 'Dashing 1.5T', body: 'Crossover', pt: 'Petrol', price: 7899000, year: 2025, status: 'Available in Pakistan', launchedAt: '2025-02-20' },
      { name: 'X70 Plus 1.5T', body: 'SUV', pt: 'Petrol', price: 8299000, year: 2026, status: 'Available in Pakistan', launchedAt: '2025-02-20' },
      { name: 'X70 Plus 7-Seater', body: 'SUV', pt: 'Petrol', price: 8799000, year: 2026, status: 'Available in Pakistan', launchedAt: '2025-02-20' },
      { name: 'T2 i-DM', body: 'SUV', pt: 'PHEV', price: 12795000, year: 2026, status: 'Available in Pakistan', battery: '18.4 kWh', range: '90 km EV / 1,100 km total', launchedAt: '2026-07-06' },
      { name: 'T2 2.0 XWD', body: 'SUV', pt: 'Petrol', price: 13590000, year: 2026, status: 'New Arrival', launchedAt: '2026-08-27' },
      { name: 'T1 i-DM', body: 'SUV', pt: 'PHEV', price: 10799000, year: 2026, status: 'New Arrival', battery: '18.4 kWh', range: '90 km EV', launchedAt: '2026-08-27' },
      { name: 'T1 Petrol', body: 'SUV', pt: 'Petrol', price: 0, year: 2026, status: 'New Arrival', launchedAt: '2026-08-27' },
      { name: 'T3', body: 'SUV', pt: 'Petrol', price: 0, year: 2026, status: 'Expected', launchedAt: '2026-12-01' },
  ...
  },
  {
    ...
    tagline: 'Changan NEVO electrified 4x4s — Hunter REEV launched 20 Aug 2026.',
    models: [
      { name: 'Hunter', body: 'Pickup', pt: 'REEV', price: 10990000, year: 2026, status: 'New Arrival', battery: '31.2 kWh', range: '180 km EV / 1,030 km total', launchedAt: '2026-08-20' },
  ...
  },
  {
    ...
    tagline: 'Chery design-led crossovers — E5 BEV launched Aug 2025; 7 SHS-P PHEV launched Aug 2026.',
    models: [
      ...
      { name: '7 SHS-P', body: 'Crossover', pt: 'PHEV', price: 10649000, year: 2026, status: 'Available in Pakistan', battery: '19.4 kWh', range: '95 km EV', launchedAt: '2026-08-12' },
    ],
  },
  {
  ...
  },
  {
    ...
    models: [
      ...
      { name: 'Atto 2 Electric', body: 'Crossover', pt: 'EV', price: 7290000, year: 2026, status: 'Available in Pakistan', battery: '45.1 kWh', range: '380 km', launchedAt: '2026-01-24' },
      ...
      { name: 'Sealion 7 AWD', body: 'Crossover', pt: 'EV', price: 15490000, year: 2026, status: 'Available in Pakistan', battery: '82.5 kWh', range: '502 km', launchedAt: '2026-01-24' },
      { name: 'Sealion 6 DM-i', body: 'Crossover', pt: 'PHEV', price: 0, year: 2026, status: 'Coming Soon', battery: '18.3 kWh', range: '92 km EV', launchedAt: '2026-12-01' },
